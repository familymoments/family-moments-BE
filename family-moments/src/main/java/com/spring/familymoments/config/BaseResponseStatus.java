...
public enum BaseResponseStatus {
    ...
    INVALID_JWT(false, HttpStatus.UNAUTHORIZED.value(), "Access Token의 기한이 만료되었습니다. 재발급 API를 호출해주세요"),
    ...
    POST_USERS_EXISTS_BIRTH(false, HttpStatus.BAD_REQUEST.value(), "생년월일을 입력해주세요"),
